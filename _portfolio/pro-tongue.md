...
As part of my work for this [manuscript](/publication/glossectomy), developed alongside collaborators from Johns Hopkins Medical School, I built an interactive tool to predict 30-day postoperative complications (Bleeding Transfusion, Pneumonia, Unplanned Reoperation, Surgical Site Infection, Any Complication, Serious Complications) following glossectomy for tongue cancer. It leverages tree-based calibrated model architectures—including LightGBM and XGBoost—trained and temporally validated on patients from the ACS‑NSQIP dataset from 2008–2024.
